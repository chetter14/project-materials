...
#define __LusbapiH__
	...
	enum ADC_INPUT_RANGE_E154 {	ADC_INPUT_RANGE_5000mV_E154, ADC_INPUT_RANGE_1600mV_E154, ADC_INPUT_RANGE_500mV_E154, ADC_INPUT_RANGE_160mV_E154, INVALID_ADC_INPUT_RANGE_E154 };
	// доступные индексы источника тактовых импульсов для АЦП, сохранены для совместимости с E14-140
	enum ADC_CLOCK_E154 {	INT_ADC_CLOCK_E154, EXT_ADC_CLOCK_E154, INVALID_ADC_CLOCK_E154 };
	// доступные индексы управления трансляцией тактовых импульсов АЦП
	// на линию SYN внешнего цифрового разъёма (только при внутреннем
	// источнике тактовых импульсоц АЦП),   сохранены для совместимости с E14-140
	enum ADC_CLOCK_TRANS_E154 {	ADC_CLOCK_TRANS_DISABLED_E154, ADC_CLOCK_TRANS_ENABLED_E154, INVALID_ADC_CLOCK_TRANS_E154 };
	// возможные типы синхронизации модуля E-154
	enum SYNC_E154 { 	NO_SYNC_E154, TTL_START_SYNC_E154, TTL_KADR_SYNC_E154, ANALOG_SYNC_E154, INVALID_SYNC_E154 };
	// возможные опции наличия микросхемы ЦАП
